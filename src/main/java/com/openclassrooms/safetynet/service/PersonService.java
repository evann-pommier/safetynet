...
/**
 * Service gérant la logique métier pour l'endpoint /person. Permet de consulter
 * et de gérer les personnes (ajout, mise à jour, suppression).
 */
@Service
...
public class PersonService {
	...
	/**
	 * Ajoute une nouvelle personne. Le prénom et le nom forment un identifiant
	 * unique.
	 *
	...
	/**
	 * Met à jour une personne existante. Le prénom et le nom servent d'identifiant
	 * unique et ne peuvent pas être modifiés.
	 *
	...
	public boolean deletePerson(String firstName, String lastName) {
		boolean deleted = dataService.getPersons()
				.removeIf(p -> p.firstName().equals(firstName) && p.lastName().equals(lastName));
		if (deleted) {
			save();
